...
const Hero = () => {
  ...
  const images = [
    {
      src: "https://i.ibb.co.com/wh7mTYKL/1978.jpg",
    ...
    {
      src: "https://i.ibb.co.com/Swkr80Hd/4908.jpg",
    ...
    {
      src: "https://i.ibb.co.com/9HyRNXzt/2151961782.jpg",
    ...
    <div className="pb-5">
      <div className="relative w-full h-[500px] overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center z-30 px-6">
          <h1 className="text-3xl md:text-5xl lg:text-7xl font-semibold text-[#f1f1f1] drop-shadow-lg">
